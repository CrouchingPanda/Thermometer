...
void top_layer_init(void) {
  ...
  lv_msg_subsribe_obj(NEW_BATTERY_PERCENTAGE_MSG, low_battery_modal, NULL);
  ...
  lv_msg_subsribe_obj(NEW_BATTERY_CHARGING_STATUS_MSG, charging_indicator, NULL);
  ...
  lv_msg_subsribe_obj(NEW_BATTERY_PERCENTAGE_MSG, battery_indicator, NULL);
}