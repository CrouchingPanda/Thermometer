 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --bpp 4 --size 16 --font C:\Users\sasha zakharov\Documents\Arduino\thermometer\project_v2\glvgl_project\assets\Roboto-Regular.ttf -o C:\Users\sasha zakharov\Documents\Arduino\thermometer\project_v2\glvgl_project\assets\font_Roboto_16.c --format lvgl -r 0x20-0x7f --symbols °• --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4020, .adv_w = 96, .box_w = 4, .box_h = 5, .ofs_x = 1, .ofs_y = 7},
    {.bitmap_index = 4030, .adv_w = 86, .box_w = 4, .box_h = 4, .ofs_x = 1, .ofs_y = 4}
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t font_Roboto_16 = {
#else
